...
if __name__ == "__main__":
    n = int(sys.argv[1])
    s, H, W, P = build_model(n, use_symmetry=False, max_diff=None)
    ...
    write_result_json("SAT_Z3", n, out, elapsed, optimal, sol)

    print(f"[SAT_Z3] n={n} result={res} time={elapsed:.3f}s -> {out}")
